...
<body id="body">
  ...
  <!-- ======= Header ======= -->
  <header id="header" class="fixed-top bg-info" style="background-color: #37517e !important;">
      ...
      <div class='d-flex'>
        <h1 class="logo me-auto d-flex">
          ...
          <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" id='formpesqu'>
            ...
            <button type="submit" data-nome="services" class='btnpesqu' id='btnpesqu' name='btnpesqu'>
...
?>
      ...
      <section id="services" class="services section-bg">
        <div class="container" data-aos="fade-up">
          ...
          <div class="section-title">
            <h2 style="margin-top: 2em;">Serviços</h2>
            ...
            if(isset($_POST['btnpesqu'])){
              ...
              if(mysqli_num_rows($resulCategoria) > 0){
                while ($categoria = mysqli_fetch_assoc($resulCategoria)) {
                  ...
                  <h4><a href='freelancer.php?id=$categoria[id_trabalho]'>$categoria[tipo_trabalho]</a></h4>
                ...
                echo "
                <h1 class='py-5 text-center'>Sem prestadores de serviço cadastrados nessa área</h1>
                ";
              }
            } else{
          ...
          <div class="row">
            ...
            <div class="col-lg-5 d-flex align-items-stretch">
              <div class="info">
                ...
                <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d31534.025256829707!2d13.203012999999999!3d-8.9025258!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1spt-PT!2sao!4v1684694860700!5m2!1spt-PT!2sao" frameborder="0" style="border:0; width: 100%; height: 290px;" allowfullscreen class="d-none"></iframe>
              </div>
    ...
    <footer id="footer">
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-md-6 footer-contact">
              ...
              <p>
                ...
                <strong>Email:</strong> info@autonomous.com<br>
              </p>
            </div>
      ...
      <div class="container footer-bottom clearfix">
        <div class="copyright">
          &copy; Copyright <strong><span>E&C</span></strong>. Todos Diteitos Reservados
        </div>
        <div class="credits">
          ...
          Desenvolvido por <a href="https://bootstrapmade.com/">E&C</a>
        </div>
      </div>
    </footer><!-- End Footer -->
          ...
          <form class="text-center d-none" id="LoginCli">
            <div class="modal-body">
              ...
              <div class="checkbox mb-3 my-2 text-start">
                <a href="#" class="nav-link text-primary">Esqueci a minha senha</a>
              </div>
